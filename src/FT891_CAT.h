...
void	 begin ( int txPin, bool debug = false );	// Initialize CAT control parameters
void	 begin ( bool debug = false );				// Initialize CAT control parameters
