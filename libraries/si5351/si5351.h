...
#define ERROR_WRITE_TCA        			1
#define ERROR_WRITE       				2
#define ERROR_WRITE_BULK       			3
...
extern uint8_t	g_bus;

class Si5351
{
public:
	Si5351(uint8_t i2c_addr = SI5351_BUS_BASE_ADDR,uint8_t i2c_sda =  SI_SDA,uint8_t i2c_scl = SI_SCL, uint8_t _bus = 255);
	...
	uint8_t	getlasterror() { return last_error; };
